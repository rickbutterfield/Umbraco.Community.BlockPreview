...
namespace Our.Umbraco.BlockGridPreview.Controllers
{
    ...
    /// </summary>
    public class BlockGridPreviewApiController : UmbracoAuthorizedJsonController
    {
        private readonly IPublishedRouter _publishedRouter;
        private readonly BlockEditorConverter _blockEditorConverter;
        private readonly ILogger<BlockGridPreviewApiController> _logger;
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="BlockGridPreviewApiController"/> class.
        /// </summary>
        ...
        public BlockGridPreviewApiController(IPublishedRouter publishedRouter, IUmbracoContextAccessor umbracoContextAccessor, BlockEditorConverter blockEditorConverter, ILogger<BlockGridPreviewApiController> logger, IVariationContextAccessor variationContextAccessor, IRazorViewEngine razorViewEngine, ITempDataProvider tempDataProvider, ITypeFinder typeFinder, IPublishedValueFallback publishedValueFallback)
        {
