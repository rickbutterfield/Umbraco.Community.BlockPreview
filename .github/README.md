...
```
dotnet add package Umbraco.Community.BlockPreview --version 1.13.0-beta
```

or the older NuGet Package Manager:

```
Install-Package Umbraco.Community.BlockPreview -Version 1.13.0-beta
```
...
![Screenshot](https://raw.githubusercontent.com/rickbutterfield/BlockPreview/develop/.github/assets/screenshot1.png "The Umbraco backoffice showing a panel titled 'Select view', with a HTML file named `block-preview.html` available for selection")
