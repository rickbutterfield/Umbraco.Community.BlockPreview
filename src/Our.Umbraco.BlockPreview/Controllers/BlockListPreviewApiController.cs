...
{
    /// <summary>
    /// Represents the Block List Preview API controller.
    /// </summary>
    public class BlockListPreviewApiController : UmbracoAuthorizedJsonController
    {
        private readonly IPublishedRouter _publishedRouter;
        private readonly BlockEditorConverter _blockEditorConverter;
        private readonly ILogger<BlockListPreviewApiController> _logger;
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="BlockListPreviewApiController"/> class.
        /// </summary>
        ...
        public BlockListPreviewApiController(IPublishedRouter publishedRouter, IUmbracoContextAccessor umbracoContextAccessor, BlockEditorConverter blockEditorConverter, ILogger<BlockListPreviewApiController> logger, IVariationContextAccessor variationContextAccessor, IRazorViewEngine razorViewEngine, ITempDataProvider tempDataProvider, ITypeFinder typeFinder, IPublishedValueFallback publishedValueFallback)
        {
